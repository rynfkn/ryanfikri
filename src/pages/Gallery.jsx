...
export default function Gallery() {
  ...
  return (
    <div className="min-h-screen text-[var(--color-text)] transition-colors duration-300 py-24 px-6">
      ...
      <div className="columns-1 sm:columns-2 md:columns-3 gap-4 max-w-5xl mx-auto space-y-4">
        {filteredImages.map((img, index) => (
          <div key={index} className="relative overflow-hidden rounded-xl group break-inside-avoid">
            <img
              src={img.image_path}
